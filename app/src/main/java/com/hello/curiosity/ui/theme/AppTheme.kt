...
import io.github.hellocuriosity.compose.ui.components.input.InputTextFieldDefaults
import io.github.hellocuriosity.compose.ui.components.selector.DropDownMenuDefaults
import io.github.hellocuriosity.compose.ui.components.toggle.CheckBoxDefaults
import io.github.hellocuriosity.compose.ui.components.toggle.ToggleDefaults
import io.github.hellocuriosity.compose.ui.theme.ColorScheme
import io.github.hellocuriosity.compose.ui.theme.Theme
import io.github.hellocuriosity.compose.ui.theme.Type

object AppTheme : Theme {
    override val typography: Type =
        Type(
            defaultFontFamily =
                FontFamily(
...
@Composable
fun checkColors(isDarkMode: Boolean = isSystemInDarkTheme()) =
...
@Composable
fun dropDownMenuColors(isDarkMode: Boolean = isSystemInDarkTheme()) =
...
@Composable
fun toggleColors(isDarkMode: Boolean = isSystemInDarkTheme()) =
